...
class USVScraper:
    ...
    def extract_clean_text(self, content_elem):
        ...
        for element in content_elem.find_all(['p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'li', 'blockquote']):
...
"""
    ...
    def scrape_all_articles(self, output_dir="usv_articles"):
        ...
        print("=" * 60)
        print(f"Successfully scraped: {successful_downloads}/{len(self.URLS_TO_SCRAPE)} articles")
