...
**Date:** 2020-08-10
**URL:** https://www.nosetgauge.com/p/ea-ideas-4-utilitarianism

---

_4.9k words (≈17 minutes)_

_  Posts in this series:  
_[FIRST](https://strataoftheworld.blogspot.com/2020/07/ea-ideas-1-rigour-and-opportunity-in.html) | [PREVIOUS](https://strataoftheworld.blogspot.com/2020/07/ea-ideas-3-uncertainty.html) | NEXT _  
_
...
For example, Quality- and Disability-Adjusted Life Years ([QALYs](https://en.wikipedia.org/wiki/Quality-adjusted_life_year) and [DALYs](https://en.wikipedia.org/wiki/Disability-adjusted_life_year)) try to put a number on the value of a year of life with some disease burden. Obviously it is not an easy judgement to make (usually the judgement is made by having a lot of people answer carefully designed questions on a survey), and the results are far more imprecise than the 3-significant-figure numbers in the table [on page 17 here](https://www.who.int/healthinfo/statistics/GlobalDALYmethods_2000_2011.pdf) would suggest. However, the principle that we should ask people and do studies to try figure out how much they’re suffering, and then make the decisions that reduce suffering the most across all people, seems like the most fair and just way to make medical decisions.
...
(As it should. The definition is logically separate from the implications and the implementation. Good systems, concepts, and theories are generally [narrow](https://www.lesswrong.com/posts/yDfxTj9TKYsYiWH5o/the-virtue-of-narrowness).)
...
For example, knowledge has no _intrinsic_ value in utilitarianism. But having an accurate picture of what the world is like is so important for judging what is good that, in practice, you can basically regard accurate knowledge as a moral end in itself. (I think that unless you never intend to be responsible for others or take actions that significantly affect other people, when deciding whether to consider something true you should care only about its literal truth value, and not at all about whether it will make you feel good to believe it.)

To take another example: integrity, in the sense of being honest and keeping commitments, clearly matters. This is not obvious if you look at the core ideas of utilitarianism, in the same way that the Chinese Remainder Theorem is not obvious if you look at the axioms of arithmetic. That doesn’t somehow make it un-utilitarian; for some examples of arguments, see [here](https://forum.effectivealtruism.org/posts/CfcvPBY9hdsenMHCr/integrity-for-consequentialists).

See also [this article](https://www.lesswrong.com/posts/K9ZaZXDnL3SEmYZqB/ends-don-t-justify-means-among-humans) for ideas on why strictly following rules can make sense even for strict consequentialists, given only the fact that human brains are fallible in predictable ways.
...
Many thought experiments show this. The most famous is the [trolley problem](https://en.wikipedia.org/wiki/Trolley_problem), where the utilitarian answer requires diverting a trolley from a track containing 5 people to one containing only a single person (an alternative telling is doctors killing a random patient to get the organs to save five others). Another is the [mere addition paradox](https://en.wikipedia.org/wiki/Mere_addition_paradox), also known as the repugnant conclusion: we should consider a few people living very good lives as a worse situation than many people living mediocre lives.
...
Finally, there is a specific bias that explains why the repugnant conclusion seems so repugnant. Humans tend to show [scope neglect](https://en.wikipedia.org/wiki/Scope_neglect). If our brains were built differently, and assigned due weight to the greater quantity of life in the “repugnant” choice, I think we’d find it the intuitive one.

However, population ethics is both notoriously tricky and a fairly new discipline, so there is always the chance there exists a better alternative [population axiology](http://users.ox.ac.uk/~mert2255/papers/population_axiology.pdf) than totalism.
...
Two of the great utilitarian philosophers were [Jeremy Bentham](https://en.wikipedia.org/wiki/Jeremy_Bentham#Animal_rights) and [John Stuart Mill](https://en.wikipedia.org/wiki/John_Stuart_Mill), who died in the early and late 1800s respectively (today we have [Peter Singer](https://en.wikipedia.org/wiki/Peter_Singer)). On the basis of his utilitarian ethics, Bentham advocated for the abolition of slavery and capital punishment, gender equality, decriminalising homosexuality (an essay so radical at its time that it went unpublished for over a hundred years after Bentham’s death), and is especially known as one of the first defenders of animal rights. Mill also argued against slavery, and is especially known as an early advocate of women’s rights. Both were also important all-around liberals.
